...
- `0.2.0-p0.a-stresslog` 已构建成功，固件 648,224 bytes，在现有 640 KiB App 槽中余 7,136 bytes；已覆盖到 SD 并核对 SHA-256 `ff1411a70fa8fb6c3196e901ce1e73281d95376b109abb411d4a7713ab16b408`，尚未真机运行，P0-05 仍为 `DEVICE TEST`，A 仅为 provisional winner，未修改或冻结 PRD / TECH_DESIGN。
