...
| P3C Media Resources | DEVICE TEST | P3-03～06、P3-12 | `0.7.4` 当前句 / 16px / 整词换列 / 音量限幅 / ASCII校准，待新日志 |
...
- [ ] 不做逐字 Karaoke
- [ ] 中文默认楷体约16 px，英文Times New Roman约12 px；英文单词优先整体换列
- [ ] 字体大小允许真机约 ±2 px 微调
- [ ] UI 不自动旋转
- [ ] 中文右 / 原文左、同语言右起续列；长句先完整多列，仅极长句自动阅读分页
- [ ] 首句时间戳前Content留空；Pause冻结分页、Seek直接定位；整组无横移切换，更新≤200ms / 呈现≤100ms
...
- [ ] 默认34×26，较30×24细化；保留实际字符mask而非普通缩略图
