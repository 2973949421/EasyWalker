...
int32_t measuredWidth(M5GFX& display, const char* text) {
...
int32_t prefixWidth(M5GFX& display, char* text, size_t bytes) {
...
size_t fittingPrefix(M5GFX& display, char* text, size_t bytes, int32_t width) {
    if (width < 0) {
        return 0;
    }
    display.setCursor(0, 0);
...
size_t preferredBreak(M5GFX& display, char* text, size_t bytes, size_t fit,
                      int32_t width) {
    size_t preferred = 0;
...
void appendEllipsis(M5GFX& display, char* line, size_t& bytes, int32_t width,
...
UiTextLayoutResult layout(M5GFX& display, const char* text,
...
UiTextLayoutResult UiTextLayout::draw(M5GFX& display, const char* text,
                                     const UiTextBox& box, size_t byteLength) {
    return layout(display, text, box, byteLength, true);
}

UiTextLayoutResult UiTextLayout::measure(M5GFX& display, const char* text,
                                        const UiTextBox& box, size_t byteLength) {
