...
class LibraryVisual {
 public:
    ...
    void release(){cover.release();visible_=false;}
    void invalidate(){imageY_=0;bottomY_=164;nameDone_=false;clear_=true;nameLayout={};}
    ...
    bool complete()const{return nameDone_&&bottomY_>=240&&imageY_>=120;}
 ...
 private:
    ...
    int imageY_=0,bottomY_=164,direction_=0;
