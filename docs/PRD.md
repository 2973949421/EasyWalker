...
顶部174px容纳完整比例的曲库图；五人原图1074×1380生成135×173，填满宽度、不裁人物、不额外留左右黑条。下方完整名称采用华文行楷18px / Kunstler Script 22px，实际一行22px、两行44px，逐行居中。名称下方至屏幕底部是一组重叠黑胶轮盘，不另设按钮栏。当前唱片居中最高、绘于最前；两侧相邻唱片更低且部分遮挡，圆心沿共同圆弧移动，下半部允许越出屏幕。右键使右侧唱片升到中央，原中央向左下退；无黄色轮廓、大圆框或扇区，平时不旋转。切换约160ms、最多4帧，连续操作跟随最新选择；0/1/2曲库不复制凑数。上半弧短名采用华文行楷12px / Kunstler Script 14px，只画完整可见字形，完整名称以上方为准。其他页面仍为楷体 / Times，歌词和时间字号不变。
