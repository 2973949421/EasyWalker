...
顶部174px容纳完整比例的曲库图；五人原图1074×1380生成135×173，填满宽度、不裁人物、不额外留左右黑条。下方约32px显示最多两行完整名称，逐行按实际字宽居中；底部约30px为紧凑唱片带。唱片平时静止，仅切换时约160ms、最多4帧；连续选择以最新项为准。最多显示前一张、当前张、后一张，少于三张时不复制凑数。当前唱片上浮、标签更亮；弧形短名仅在可见弧长内显示，完整名称以上方为准。
